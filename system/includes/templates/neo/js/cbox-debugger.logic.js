function fw_toggle(divid){
	if ( document.getElementById(divid).className == "fw_closed"){
		document.getElementById(divid).className = "fw_expanded";
		document.getElementById(divid + '_minor_menu').className = "fw_expanded";
		
	} else {
		document.getElementById(divid).className = "fw_closed";
		document.getElementById(divid + '_minor_menu').className = "fw_closed";
	}
}
function fw_poprc(divid){
	var _div = document.getElementById(divid);
	var _link = document.getElementById(divid + '_link');
	 
	
	if (_div.className == 'fw_hidden') {
		document.getElementById(divid).className = "showRC";
		_link.innerHTML = 'Hide';
		
	} else {
		document.getElementById(divid).className = "fw_hidden";
		_link.innerHTML = 'View';
