...
<head>
	...
	<!--- Include Header --->
	<cfinclude template="/coldbox/system/includes/templates/neo/DebugHeader.cfm">
</head>
<body>
	...
	<div class="fw_debugContentView" id="fw_executionprofiler">
		...
		<div>
			...
			<select id="frequency" onChange="fw_pollmonitor('profiler',this.value,'#URLBase#')">
	...
	<div align="center"><input type="button" name="close" value="Close Monitor" onClick="window.close()"></div>
</body>
</html>
</cfoutput>
