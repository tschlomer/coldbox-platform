...
<div class="fw_debugPanel">
	...
	<!--- TRACER STACK--->
	<!--- **************************************************************--->
	<cfinclude template="/coldbox/system/includes/templates/traditional/panels/TracersPanel.cfm">
...
<!--- **************************************************************--->
	...
	<div class="fw_debugContent<cfif getDebuggerConfig().getExpandedRCPanel()>View</cfif>" id="fw_reqCollection">
		...
		<cfinclude template="/coldbox/system/includes/templates/traditional/panels/CollectionPanel.cfm">
		<!--- Private Collection --->
